...
public class AddImageToDBTest extends LambdaTest{

	void testSuccessInput(String incoming) throws IOException {
    	AddImageToDB handler = new AddImageToDB();
    ...
    public void testShouldBeOk() {
    	...
    	AddImageRequest atr = new AddImageRequest("7","hhh","10,50","b","1","Mi43MTgyODE4Mjg=");
