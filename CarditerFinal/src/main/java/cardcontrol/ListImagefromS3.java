...
public class ListImagefromS3 implements RequestStreamHandler {
	...
	List<String> getImages() throws Exception{
		...
		imageList = s3.listObjects("cs509finalinteration","cs509finalinteration/");
		...
		for(S3ObjectSummary s: images)
		{
			...
			key=s.getKey();
			System.out.println("*************************************************************************");
			System.out.println("https://cs509finalinteration.s3.us-east-2.amazonaws.com/cs509finalinteration/"+key);
